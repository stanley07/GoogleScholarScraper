...
def create_email_content(name, email, interests, papers):
    ...
    success_page_url = 'http://127.0.0.1:5008/success'
...
def send_weekly_emails():
    ...
    for user in users:
        ...
        send_email_async(email, *email_content, attachment_filenames)
...
def register():
    try:
        ...
        if name and email and interests:
            ...
            attachment_filenames = []
            send_email_async(email, subject, email_content, attachment_filenames)
...
if __name__ == '__main__':
    ...
    # Start a separate thread to send weekly emails
